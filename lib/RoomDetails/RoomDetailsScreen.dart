...
class _RoomDetailsScreenState extends State<RoomDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot<Messages>> messagesStream = messageRef.orderBy('time').snapshots();
        ...
        children:[
          ...
          Scaffold(
            ...
            Container(
              ...
              child: Column(
                children: [
                  Expanded(child: StreamBuilder<QuerySnapshot<Messages>>(
                    stream: messagesStream,
                      builder: (BuildContext buildContext, AsyncSnapshot<QuerySnapshot<Messages>> snapshot)
                      {
                        if(snapshot.hasError)
                        ...
                        else if (snapshot.hasData)
                          {
                            ...
                            return ListView.builder(itemBuilder: (buildContext,index) {
                              ...
                              return Text(snapshot.data?.docs[index].get('content')??"");
  ...
  void sendMessage(){
    ...
    final message = Messages(id: newMessageObj.id, content: typedMessage, time: DateTime.now().microsecondsSinceEpoch, senderName: provider.currentUser?.username??"", senderId: provider.currentUser?.id??'');
